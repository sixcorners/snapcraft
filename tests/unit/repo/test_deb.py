...
class TestUbuntuInstallRepo(unit.TestCase):
    ...
    def test_install(self, mock_refresh):
        ...
        with mock.patch(
            ...
            repo.Ubuntu.install_source(name="test-name", source=test_source)
            ...
            repo.Ubuntu.install_source(name="test-name2", source=test_source2)
    ...
    def test_install_gpg(self, mock_run):
        repo.Ubuntu.install_gpg_key(key_id="FAKEID", key="FAKEKEY")
